...
export class AccountsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async getValidatorsList(requestParameters: GetValidatorsListRequest, initOverrides?: RequestInit): Promise<Array<ValidatorRow>> {
        const response = await this.getValidatorsListRaw(requestParameters, initOverrides);
        return await response.value();
    }
